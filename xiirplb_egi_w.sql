...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Mar 2023 pada 09.23
...
CREATE TABLE `level` (
  ...
  `nama_level` enum('admin','kasir','pelanggan') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `detail_order`
  ...
  ADD KEY `orders` (`id_order`),
  ADD KEY `masakans` (`id_masakan`);
...
--
ALTER TABLE `detail_order`
  ADD CONSTRAINT `masakans` FOREIGN KEY (`id_masakan`) REFERENCES `masakan` (`id_masakan`),
  ADD CONSTRAINT `orders` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`);

--
-- Ketidakleluasaan untuk tabel `transaksi`
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `order` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`),
