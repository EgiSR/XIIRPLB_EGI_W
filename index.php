    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col">
        <div class="card shadow-sm">
          <img src="assets/img/makanan/Resep-Sate-Kambing-Empuk.jpg" class="img-fluid" alt="pool">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card shadow-sm">
          <img src="assets/img/makanan/rendang.jpg" class="img-fluid" alt="gym">
          <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="assets/img/makanan/mie-goreng-korea.jpg" class="img-fluid" alt="restorant">
              <div class="card-body">
